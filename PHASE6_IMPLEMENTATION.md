...
Example output:
1. Sony WH-1000XM5 (₹27,999)
2. OnePlus 12 (₹62,999)
3. Apple MacBook Air M3 (₹1,06,999)
4. Samsung Galaxy S24 Ultra (₹1,27,999)
5. Apple iPhone 15 Pro Max (₹1,56,999)
```
...
Example output:
1. Apple iPhone 15 Pro Max (₹1,56,999)
2. Samsung Galaxy S24 Ultra (₹1,27,999)
3. Apple MacBook Air M3 (₹1,06,999)
4. OnePlus 12 (₹62,999)
5. Sony WH-1000XM5 (₹27,999)
```
...
- Results count: "Showing all 5 products"
- URL: `products.html`
...
✓ Won't crash the application
✓ Doesn't skip products (all 5 still displayed)
...
- For 5 products: ~100-150 comparisons
...
TEST 1: Data Structure Validation
   ✓ 5/5 products have valid structure

TEST 2: Price Extraction
   ✓ 5/5 products have valid prices

TEST 3: Price Sorting (Low to High)
   ✓ Correctly sorted: Sony WH-1000XM5 (₹27,999) → Apple iPhone 15 Pro Max (₹1,56,999)

TEST 4: Price Sorting (High to Low)
   ✓ Correctly sorted: Apple iPhone 15 Pro Max (₹1,56,999) → Sony WH-1000XM5 (₹27,999)

TEST 5: Name Sorting (A to Z)
   ✓ Correctly sorted: Apple iPhone 15 Pro Max → Sony WH-1000XM5

TEST 6: Name Sorting (Z to A)
   ✓ Correctly sorted: Sony WH-1000XM5 → Apple iPhone 15 Pro Max
...
- [ ] Load products.html → all 5 products display in original order
...
- [ ] Search "laptop" → shows 1 result
- [ ] Apply "Price: Low to High" → laptops sorted by price
- [ ] Category "smartphones" + "Name: A to Z" → 3 smartphones sorted alphabetically
...
| Performance | <1ms for 5 products |
