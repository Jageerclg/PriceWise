...
const ProductDataService = (function() {
    ...
    function getDefaultProvider() {
        // Live backend API first so pasted marketplace URLs return real
        // product data. The mock provider remains available explicitly
        // (providers.mock / MockProductProvider) for offline development.
    ...
    async function importProductFromUrl(url) {
        ...
        return {
            ...
            source: (productRecord && productRecord.source) || providerResult.source || 'mock',
            sourceType: (productRecord && productRecord.sourceType) || providerResult.sourceType || 'mock',
            message: providerResult.message || 'Product imported successfully.'
        };
    }
